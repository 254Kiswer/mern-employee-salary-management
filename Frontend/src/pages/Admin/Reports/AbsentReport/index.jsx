...
import { fetchAbsentReportByMonth, fetchAbsentReportByYear, getMe } from '../../../../config/redux/action';
...
const AbsentReport = () => {
    ...
    const handleSearch = async (event) => {
        ...
        await Promise.all([
            dispatch(fetchAbsentReportByYear(selectedYear, () => (yearDataFound = true))),
            dispatch(fetchAbsentReportByMonth(selectedMonth, () => (monthDataFound = true))),
        ]);
        setShowMessage(true);
        ...
        if (yearDataFound && monthDataFound) {
            ...
            navigate(
                `/report/absent/print-page?month=${selectedMonth}&year=${selectedYear}`
            );
        } else {
            setShowMessage(false);
            Swal.fire({
    ...
    return (
        <Layout>
            <Breadcrumb pageName='Employee Absent Report' />
