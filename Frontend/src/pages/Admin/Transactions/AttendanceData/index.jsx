...
const attendanceData = () => {
    ...
    const filteredAttendanceData = attendanceData.filter((attendanceData) => {
        ...
        const isMatchName=
            filterName === "" ||
            attendanceData.employeeName.toLowerCase().includes(filterName.toLowerCase());
                            ...
                            {filteredAttendanceData.slice(startIndex, endIndex).map((data, index) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black text-center dark:text-white'>{data.id}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{data.employeeName}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{data.employee_jobTitle}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Displaying {startIndex + 1}-{Math.min(endIndex, filteredAttendanceData.length)} of {filteredattendanceData.length} Employee Attendance Data 
                        </span>
                    </div>
