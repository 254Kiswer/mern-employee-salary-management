...
const DeductionData = () => {
    ...
    return (
        <Layout>
            ...
            <Link to="/deduction-data/form-deduction-data/add" >
                <ButtonOne  >
                            ...
                            {filteredDeductionData.slice(startIndex, endIndex).map((data, index) => {
                                return (
                                    <tr key={data.id}>
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>Ksh. {data.amount}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <div className='flex items-center space-x-3.5'>
                                                <Link
                                                    className='hover:text-black'
                                                    to={`/deduction-data/form-deduction-data/edit/${data.id}`}
                                                >
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Displaying {startIndex + 1}-{Math.min(endIndex, filtereddeductionData.length)} of {filtereddeductionData.length} Deduction Data
                        </span>
                    </div>
