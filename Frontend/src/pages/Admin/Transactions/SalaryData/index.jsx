...
const SalaryData = () => {
    ...
    const filteredSalaryData = salaryData.filter((employeeSalaryData) => {
        ...
        const isMatchName =
            filterName === "" ||
            (typeof employeeSalaryData.EmployeeName === 'string' &&
                employeeSalaryData.EmployeeName.toLowerCase().includes(filterName.toLowerCase()));
                            ...
                            {filteredSalaryData.slice(startIndex, endIndex).map((data, index) => {
                                return (
                                    <tr key={data.id}>
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>Ks. {data.basicSalary}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>Ksh. {data.transportALLowance}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>Ksh. {data.mealAllowance}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>Ksh. {data.deduction}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>Ksh. {data.total}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark'>
                                            <div className='flex items-center space-x-3.5'>
                                                <Link
                                                    className='hover:text-black'
                                                    to={`/salary-data/detail-salary-data/name/${data.employeeName}`}
                                                >
