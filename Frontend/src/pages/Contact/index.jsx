                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                        ...
                        >
                            <div className="flex items-center my-6">
                                ...
                                <h3 className="font-medium dark:text-white">NFT Autoports Freight Terminal Limited</h3>
                            </div>
                            <div className="flex items-center my-6">
                            ...
                            <div className="flex items-center my-6">
                                ...
                                <h3 className="font-medium dark:text-white">info@nft-autoportsfreight.com</h3>
                            </div>
                            <div className="flex items-center my-6">
