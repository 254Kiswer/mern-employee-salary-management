...
export const GET_EMPLOYEE_DATA_BY_NID_SUCCESS = 'GET_EMPLOYEE_DATA_BY_NID_SUCCESS';
export const GET_EMPLOYEE_DATA_BY_NID_FAILURE = 'GET_EMPLOYEE_DATA_BY_NID_FAILURE';
